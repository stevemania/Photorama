...
class TagsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.delegate = self // updates tags if selected or de-elected
        updateTags()
    }
    ...
    @IBAction func addNewTag(_ sender: UIBarButtonItem){
        ...
        alertController.addTextField {
            (textField) -> Void in textField.placeholder = "tag name"
    ...
    override func tableView(_ tableView: UITableView,
                            didSelectRowAt indexPath: IndexPath) { let tag = tagDataSource.tags[indexPath.row]
